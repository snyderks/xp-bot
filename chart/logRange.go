...
// LogRange is a logarithm scale range.
...
// GetMin gets the min value for the range.
...
func (r LogRange) GetDelta() float64 {
	return math.Log10(r.Max) - math.Log10(r.Min)
}
...
func (r LogRange) Translate(value float64) int {
	normalized := math.Log10(value) - math.Log10(r.Min)
